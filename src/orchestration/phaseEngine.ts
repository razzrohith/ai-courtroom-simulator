...
export function getSpeakersForPhase(phase: CourtPhase): AgentRole[] {
  const speakerMap: Record<CourtPhase, AgentRole[]> = {
    case_setup: [],
    court_opening: ['judge', 'prosecutor', 'defense', 'judge'],
    plaintiff_opening: ['judge', 'prosecutor', 'defense', 'judge'],
    defense_opening: ['judge', 'defense', 'prosecutor', 'judge'],
    evidence_presentation: ['judge', 'prosecutor', 'defense', 'judge', 'prosecutor', 'defense', 'judge'],
    objection_ruling: ['judge'],
    cross_examination: ['judge', 'prosecutor', 'defense', 'prosecutor', 'defense', 'judge'],
    witness_testimony: ['judge', 'prosecutor', 'defense', 'judge'],
    motion_hearing: ['judge', 'prosecutor', 'defense', 'judge'],
    jury_instructions: ['judge'],
    rebuttal: ['judge', 'prosecutor', 'defense', 'prosecutor', 'defense'],
    closing_arguments: ['judge', 'prosecutor', 'defense', 'judge'],
